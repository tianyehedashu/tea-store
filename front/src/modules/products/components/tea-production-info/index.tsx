        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-3">
            {metadata.harvest_season && (
              <div>
                <Text className="text-sm font-medium text-sage-600">Harvest Season</Text>
                <Text className="text-sage-800">
                  {harvestSeasonMap[metadata.harvest_season] || metadata.harvest_season}
                </Text>
              </div>
            )}
            ...
            {metadata.harvest_date && (
              <div>
                <Text className="text-sm font-medium text-sage-600">Harvest Date</Text>
            ...
            {metadata.harvest_standard && (
              <div>
                <Text className="text-sm font-medium text-sage-600">Picking Standard</Text>
                <Text className="text-sage-800">
                  {harvestStandardMap[metadata.harvest_standard] || metadata.harvest_standard}
                </Text>
              </div>
            )}
          </div>
          ...
          <div className="space-y-3">
            {metadata.leaf_grade && (
              <div>
                <Text className="text-sm font-medium text-sage-600">Leaf Grade</Text>
            ...
            {metadata.vintage_year && (
              <div>
                <Text className="text-sm font-medium text-sage-600">Vintage Year</Text>
            ...
            {metadata.aging_period && (
              <div>
                <Text className="text-sm font-medium text-sage-600">Aging Period</Text>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-3">
            {metadata.processing_methods && (
              <div>
                <Text className="text-sm font-medium text-cream-700">Processing Methods</Text>
            ...
            {metadata.oxidation_level && (
              <div>
                <Text className="text-sm font-medium text-cream-700">Oxidation Level</Text>
                <Text className="text-cream-800">{metadata.oxidation_level}</Text>
              </div>
            )}

            {metadata.fermentation_type && (
              <div>
                <Text className="text-sm font-medium text-cream-700">Fermentation</Text>
                <Text className="text-cream-800">{metadata.fermentation_type}</Text>
              </div>
            )}
          </div>
          ...
          <div className="space-y-3">
            {metadata.drying_method && (
              <div>
                <Text className="text-sm font-medium text-cream-700">Drying Method</Text>
            ...
            {metadata.roasting_level && (
              <div>
                <Text className="text-sm font-medium text-cream-700">Roasting Level</Text>
                <Text className="text-cream-800">{metadata.roasting_level}</Text>
              </div>
            )}

            {metadata.processing_master && (
              <div>
                <Text className="text-sm font-medium text-cream-700">Processing Master</Text>
                <Text className="text-cream-800">{metadata.processing_master}</Text>
              </div>
            )}
          </div>
        </div>
