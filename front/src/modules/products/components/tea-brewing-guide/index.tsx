    ...
    <div className="space-y-6">
      ...
      {metadata.steeping_times && metadata.steeping_times.length > 0 && (
        <div className="border border-orange-200 rounded-lg p-4 bg-orange-50">
          <Heading
            level="h3"
            className="text-lg font-semibold text-orange-700 mb-4 flex items-center gap-2"
          >
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
              <path
                fillRule="evenodd"
          ...
          <div className="space-y-3">
            {metadata.steeping_times.map((step, index) => (
              <div
                key={index}
                className="flex items-center gap-4 p-3 bg-white rounded-md border border-orange-100"
              >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              {metadata.vessel_recommendations.map((vessel, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="flex items-start gap-3 p-3 bg-white rounded-md border border-purple-100"
                  >
