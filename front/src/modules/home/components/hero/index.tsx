      ...
      <div className="relative z-10 content-container">
        <div className="grid small:grid-cols-2 gap-16 items-center min-h-[90vh] py-20">
          ...
          <div className="space-y-10">
            <div className="space-y-8">
              ...
              <div className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/80 backdrop-blur-sm rounded-full border border-sage-200/50 shadow-sm">
                ...
                <span className="text-sage-700 text-sm font-medium tracking-wide">Tea with a Zen State of Mind</span>
              </div>
              
              <div className="space-y-6">
                <h1 className="font-display text-4xl small:text-5xl large:text-6xl font-light text-sage-900 leading-[1.1] tracking-tight">
                  Sip the
                  <span className="block font-medium text-brand-700 italic">Calm</span>
                </h1>
                ...
                <div className="space-y-4">
                  ...
                  <p className="text-base text-sage-600 leading-relaxed max-w-md">
                    Where eastern wisdom meets mindful living. Each cup invites you to pause, 
                    breathe deeply, and find your center in the gentle rhythm of tea ceremony.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-col small:flex-row gap-4">
              <LocalizedClientLink href="/store" className="group inline-flex items-center gap-3 px-8 py-4 bg-sage-900 text-white rounded-lg hover:bg-sage-800 transition-all duration-300 font-medium">
                Discover Our Teas
              ...
              <LocalizedClientLink href="/guides" className="group inline-flex items-center gap-3 px-8 py-4 border border-sage-300 text-sage-700 rounded-lg hover:border-sage-400 hover:bg-sage-50 transition-all duration-300 font-medium">
                Tea Wisdom
            ...
            <div className="pt-8 space-y-4">
              ...
              <p className="text-sm text-sage-500 italic font-light leading-relaxed">
                "Tea and Zen are one, the Way is within"<br/>
          ...
          <div className="relative">
                ...
                <div className="space-y-8 text-center">
                  ...
                  <div className="relative mx-auto w-32 h-32">
                    ...
                    <div className="absolute inset-4 bg-gradient-to-br from-brand-100 to-brand-200 rounded-full flex items-center justify-center">
                      <div className="w-16 h-16 flex items-center justify-center">
                        ...
                        <svg className="w-12 h-12 text-brand-600" fill="currentColor" viewBox="0 0 24 24">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-sage-600 font-light leading-relaxed max-w-sm mx-auto">
                      Every sip becomes a meditation. In our busy lives, create moments of 
                      tranquil mindfulness and let your spirit find its natural center.
                    </p>
                  </div>
            ...
            <div className="absolute -top-4 -right-4 w-8 h-8 bg-brand-100 rounded-full opacity-60 animate-pulse" style={{animationDelay: '0s'}}></div>
            <div className="absolute -bottom-6 -left-6 w-6 h-6 bg-sage-200 rounded-full opacity-40 animate-pulse" style={{animationDelay: '2s'}}></div>
            <div className="absolute top-1/3 -right-8 w-4 h-4 bg-cream-200 rounded-full opacity-50 animate-pulse" style={{animationDelay: '4s'}}></div>
          </div>
        </div>
      </div>
