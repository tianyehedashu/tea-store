...
export default async function Home(props: {
  ...
  const teaCategories = categories?.filter(cat => cat.name.includes('Tea')) || []
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-16 space-y-6">
              ...
              <p className="text-lg text-sage-600 font-light max-w-2xl mx-auto leading-relaxed">
                Each tea tradition offers a unique pathway to mindfulness, inviting you to discover 
                tranquility through the ancient art of tea ceremony.
              </p>
            </div>
            ...
            <div className="text-center mt-16 pt-8 border-t border-sage-200/50">
              <p className="text-sm text-sage-500 italic font-light max-w-xl mx-auto leading-relaxed">
                Traditional tea wisdom recognizes six main categories, each embodying unique craftsmanship 
                and cultural heritage, reflecting different philosophies of mindful living.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="content-container">
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-sage-600 max-w-2xl mx-auto">
                Handpicked selections of our finest teas, perfect for discovering new favorites
              </p>
            </div>
        ...
        <div className="content-container">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="text-center mb-16 space-y-6">
              ...
              <p className="text-lg text-sage-600 font-light max-w-2xl mx-auto leading-relaxed">
                In the harmony of tea and meditation, find your center. Each mindful sip 
                becomes a gateway to inner stillness and profound awareness.
              </p>
            </div>
            ...
            <div className="grid small:grid-cols-3 gap-12 mb-20">
              <div className="text-center space-y-6">
                <div className="relative mx-auto w-20 h-20">
                  ...
                  <div className="absolute inset-2 bg-white rounded-full flex items-center justify-center">
                    <span className="text-sage-700 text-2xl font-light">🧘</span>
                  </div>
                </div>
                <div className="space-y-3">
                                      <h3 className="text-lg font-medium text-sage-900">Serenity</h3>
                    <p className="text-sm text-sage-600 font-light leading-relaxed">
                      In stillness, we find clarity. Each tea ceremony begins with quieting the mind 
                      and opening the heart to the present moment.
                    </p>
                </div>
              </div>
              ...
              <div className="text-center space-y-6">
                <div className="relative mx-auto w-20 h-20">
                  ...
                  <div className="absolute inset-2 bg-white rounded-full flex items-center justify-center">
                    <span className="text-brand-700 text-2xl font-light">☯️</span>
                  </div>
                </div>
                <div className="space-y-3">
                  <h3 className="text-lg font-medium text-sage-900">Harmony</h3>
                  <p className="text-sm text-sage-600 font-light leading-relaxed">
                    True tea exists in the balance between water and leaf, heat and time, 
                    tradition and innovation, solitude and community.
                  </p>
                </div>
              </div>
              ...
              <div className="text-center space-y-6">
                <div className="relative mx-auto w-20 h-20">
                  ...
                  <div className="absolute inset-2 bg-white rounded-full flex items-center justify-center">
                    <span className="text-cream-700 text-2xl font-light">🙏</span>
                  </div>
                </div>
                <div className="space-y-3">
                  <h3 className="text-lg font-medium text-sage-900">Reverence</h3>
                  <p className="text-sm text-sage-600 font-light leading-relaxed">
                    Respect for the leaf, the water, the vessel, and the hands that prepared them. 
                    Tea teaches us gratitude for simple gifts.
                  </p>
                </div>
              </div>
            </div>
                ...
                <div className="space-y-6">
                  <div className="space-y-4">
                    ...
                    <p className="text-sage-700 font-light leading-relaxed">
                      In tranquil mountains, each tea leaf awaits its meeting with your soul. 
                      From ancient temples to modern living spaces, tea's wisdom transcends time, 
                      bringing presence and awareness to your daily ritual.
                    </p>
                    <p className="text-sage-600 font-light leading-relaxed text-sm">
                      Our carefully curated selection honors traditional cultivation methods 
                      while embracing the mindful practices that make each cup a moment of meditation.
                    </p>
                  </div>
                  
                  <div className="flex gap-4">
                    <LocalizedClientLink href="/origins" className="inline-flex items-center gap-2 text-sage-700 hover:text-sage-900 transition-colors font-medium text-sm">
                      Discover Origins
                  ...
                  <div className="aspect-square bg-gradient-to-br from-sage-50 to-brand-50 rounded-xl border border-sage-200/50 flex items-center justify-center">
                    <div className="text-center space-y-4">
                      ...
                      <div className="space-y-2">
                        <p className="text-sage-600 text-sm font-light">Traditional Wisdom</p>
                        <p className="text-xs text-sage-500">Ancient Tea Craftsmanship</p>
                      </div>
                    </div>
                  </div>
          ...
          <div className="max-w-3xl mx-auto text-center space-y-12">
            ...
            <div className="space-y-6">
              ...
              <p className="text-sage-600 font-light leading-relaxed max-w-lg mx-auto">
                Embrace mindful living with seasonal tea wisdom, meditation practices, 
                and gentle reminders to pause and breathe in life's simple pleasures.
              </p>
            </div>

            <div className="max-w-md mx-auto">
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl border border-sage-200/50 p-8 shadow-sm">
                <div className="space-y-4">
                  <input
                    type="email"
                    placeholder="Your email address"
                    className="w-full px-6 py-4 bg-sage-50/50 border border-sage-200 rounded-xl text-sage-900 placeholder-sage-500 focus:outline-none focus:border-brand-300 focus:ring-0 transition-colors font-light"
                  />
                  <button className="w-full px-6 py-4 bg-sage-800 text-white rounded-xl hover:bg-sage-900 transition-colors duration-300 font-medium text-sm tracking-wide">
                    Sip the Calm
                  </button>
                  <p className="text-xs text-sage-500 font-light">
                    No noise, only gentle wisdom shared with respect for your time.
                  </p>
                </div>
              </div>
            </div>
