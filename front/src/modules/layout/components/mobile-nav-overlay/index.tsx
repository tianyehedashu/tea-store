...
export default function MobileNavOverlay({ isOpen, onClose, categories }: MobileNavOverlayProps) {
  ...
  return (
    <>
      ...
      {/* Mobile Menu */}
      <div className={`fixed inset-y-0 left-0 w-full max-w-sm bg-white z-50 shadow-xl transform transition-transform duration-300 ease-out ${
        isOpen ? 'translate-x-0' : '-translate-x-full'
      }`}>
        
        {/* Header */}
        <div className="flex items-center justify-between p-6 border-b border-sage-200">
          <LocalizedClientLink href="/" onClick={onClose} className="font-display text-xl font-bold text-sage-900">
            Zentee
          </LocalizedClientLink>
          <button
            onClick={onClose}
        ...
        <div className="flex flex-col h-full pb-20 overflow-y-auto">
          <div className="px-6 py-6 space-y-6">
            ...
            <nav className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className={`pl-6 space-y-2 overflow-hidden transition-all duration-300 ${
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold text-sage-900 uppercase tracking-wider">Quick Actions</h3>
              ...
              <div className="grid grid-cols-2 gap-3">
                ...
                >
                  <div className="text-center space-y-2">
                    ...
                    <span className="text-sm font-medium text-sage-900">Shop</span>
                  </div>
                </LocalizedClientLink>
                ...
                >
                  <div className="text-center space-y-2">
                    ...
                    <span className="text-sm font-medium text-sage-900">Guides</span>
                  </div>
                </LocalizedClientLink>
              </div>
            </div>
          ...
          <div className="mt-auto p-6 bg-gradient-to-r from-brand-50 to-sage-50">
            <div className="text-center space-y-3">
              ...
              <p className="text-sm text-sage-600">Discover your perfect tea with our starter guide</p>
              <LocalizedClientLink
                href="/guides"
                onClick={onClose}
